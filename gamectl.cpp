...
void gamecontrol_t::change_up(unsigned long r)
{
	up = (r == 0) ? 1 : 0;
	gamecontrol_t::change();
}

void gamecontrol_t::change_down(unsigned long r)
{
	down = (r == 0) ? 1 : 0;
	gamecontrol_t::change();
}

void gamecontrol_t::change_left(unsigned long r)
{
	left = (r == 0) ? 1 : 0;
	gamecontrol_t::change();
}

void gamecontrol_t::change_right(unsigned long r)
{
	right = (r == 0) ? 1 : 0;
	gamecontrol_t::change();
}

void gamecontrol_t::change_shot(unsigned long r)
{
	shot = (r == 0) ? 1 : 0;
	gamecontrol_t::change();
}
